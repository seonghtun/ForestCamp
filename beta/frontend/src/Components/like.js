...
const likeCountHandler = (toggle, count, onClick) => {
    // console.log("likeCountHandler", toggle)
    if (toggle) {
        onClick(count + 1)
        ...
        <div onClick={toggleLike} className={className}>
            ...
            {like ? (
                ...
                <svg className={styles.svg} width="80" height="80" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#84cc16" d="M59.17 122.18c.2.99 1.31 1.87 4.39 2.07c3.08.2 5.15-.3 5.23-1.95c.09-1.65-1.14-3.49-1.34-4.88c-.2-1.39-.99-10.74-1.19-15.61c-.2-4.87-.36-14.16-.36-14.16l-4.07.43s.06 9.65-.14 14.52c-.2 4.87-1.01 12.01-1.11 13.89c-.09 1.71-1.83 3.61-1.41 5.69z" />
                    <radialGradient id="notoMapleLeaf0" cx="65.418" cy="73.028" r="42.057" gradientTransform="matrix(.9999 .0135 -.0173 1.2815 1.27 -21.44)" gradientUnits="userSpaceOnUse">
                        <stop offset=".596" stopColor="#22c55e" />
            ...
            {/* {like ? (<FontAwesomeIcon icon={fasHeart} size="3x" style={{ color: 'red' }} />
            ) : (
                <FontAwesomeIcon icon={fasHeart} size="3x" style={{ color: 'gray' }} />
            )} */}
            {/* {like ? (
                <FontAwesomeIcon icon={fasHeart} style={{ color: "#ff0000", }} />
            ) : (
                <FontAwesomeIcon icon={farHeart} style={{ color: "#858585", }} />
            )} */}
            <p>{likeCount}</p>
        </div>
    )
