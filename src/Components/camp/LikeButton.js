...
function LikeButton(props) {
  ...
  async function toggleLike() {
    ...
    if (like == true) {
      ...
      const response = await axios.delete(
        `http://43.200.73.25:3000/camp/favor/`,
        {
          data: {
            campnum: id
          }
  ...
  console.log(like);
  return (
    <div onClick={toggleLike} className={props.className}>
      {like ? (
        <svg
          width="30"
          height="30"
        ...
        >
          <path
            fill="#DF1324"
            d="M59.17 122.18c.2.99 1.31 1.87 4.39 2.07c3.08.2 5.15-.3 5.23-1.95c.09-1.65-1.14-3.49-1.34-4.88c-.2-1.39-.99-10.74-1.19-15.61c-.2-4.87-.36-14.16-.36-14.16l-4.07.43s.06 9.65-.14 14.52c-.2 4.87-1.01 12.01-1.11 13.89c-.09 1.71-1.83 3.61-1.41 5.69z"
          />
          <radialGradient
            id="notoMapleLeaf0"
            cx="65.418"
